...
class EnhancedResultFormatter:
    ...
    def format_tool_result(self, tool_name: str, result: Any, tool_args: Optional[Dict] = None) -> None:
        """
    ...
    def _format_structured_result(self, tool_name: str, data: Union[Dict, List], tool_args: Optional[Dict] = None) -> None:
    ...
    def _format_chemistry_result(self, tool_name: str, data: Dict, tool_args: Optional[Dict] = None) -> None:
        ...
        self.console.print(Panel(
            table,
            title=f"[bold cyan][=] {tool_name} Result[/bold cyan]",
            border_style="cyan"
        ))
    
    def _format_energy_result(self, tool_name: str, data: Dict, tool_args: Optional[Dict] = None) -> None:
    ...
    def _format_structure_result(self, tool_name: str, data: Dict, tool_args: Optional[Dict] = None) -> None:
        ...
        if 'structures' in data and data['structures']:
            ...
            if len(data['structures']) > 3:
                self.console.print(f"[dim]... and {len(data['structures']) - 3} more structures[/dim]")
    ...
    def _format_generic_dict(self, tool_name: str, data: Dict, tool_args: Optional[Dict] = None) -> None:
    ...
    def _format_list_result(self, tool_name: str, data: List, tool_args: Optional[Dict] = None) -> None:
    ...
    def _format_text_result(self, tool_name: str, result: Any, tool_args: Optional[Dict] = None) -> None:
    ...
    def _format_generic_result(self, tool_name: str, data: Any, tool_args: Optional[Dict] = None) -> None:
