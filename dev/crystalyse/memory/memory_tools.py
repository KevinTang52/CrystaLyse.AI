...
def get_memory_statistics() -> str:
    ...
    try:
        ...
        formatted_stats.append(f"**Session Interactions:** {stats['session']['total_interactions']}")
...
MEMORY_TOOLS_METADATA = {
    "save_to_memory": {
        ...
        "parameters": {
            ...
            "section": {"type": "string", "description": "Section to save to", "default": "Important Notes"}
        }
    },
    "search_memory": {
    ...
    "get_cached_discovery": {
        ...
        "parameters": {
            "formula": {"type": "string", "description": "Chemical formula to look up"}
        }
    },
    "get_memory_context": {
