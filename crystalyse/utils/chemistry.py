...
def classify_composition(composition: str) -> str:
    ...
    if "O" in composition and not any(x in composition for x in ["S", "Se", "Te", "F", "Cl", "Br", "I"]):
        return "oxide"
        ...
        metals = {"Li", "Na", "K", "Rb", "Cs", "Be", "Mg", "Ca", "Sr", "Ba", "Al", "Ga", "In", 
                 "Sn", "Pb", "Bi", "Sc", "Ti", "V", "Cr", "Mn", "Fe", "Co", "Ni", "Cu", "Zn",
